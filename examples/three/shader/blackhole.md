---
title: "Three.js 黑洞教程"
description: "详解 Three.js 黑洞：用 Canvas 2D 绘制内容并实时映射为 Three.js 纹理，涵盖 RawShaderMaterial、OrbitControls、Canvas 等关键实现，附完整源码与在线 Demo，适合 Three.js 着色器 学习与二次开发。"
head:
  - - meta
    - name: keywords
      content: "Three.js,黑洞,WebGL,源码,教程,在线案例,RawShaderMaterial,GLSL,OrbitControls,相机控制,Canvas纹理,动态贴图"
outline: deep
---

### 黑洞 · *Black Hole* · [▶ 在线运行案例](https://z2586300277.github.io/three-cesium-examples/#/codeMirror?navigation=ThreeJS&classify=shader&id=blackhole)
