---
title: "Three.js 天空盒教程"
description: "详解 Three.js 天空盒：基于 WebGL 实现「天空盒」可视化效果，附完整可运行源码，涵盖 OrbitControls 等关键实现，附完整源码与在线 Demo，适合 Three.js 基础 学习与二次开发。"
head:
  - - meta
    - name: keywords
      content: "Three.js,天空盒,WebGL,源码,教程,在线案例,OrbitControls,相机控制"
outline: deep
---

### 天空盒 · *Sky And Env* · [▶ 在线运行案例](https://z2586300277.github.io/three-cesium-examples/#/codeMirror?navigation=ThreeJS&classify=basic&id=skyAndEnv)
...
完整源码：[GitHub](https://github.com/z2586300277/three-cesium-examples/blob/dev/threeExamples/basic/skyAndEnv.js)
