---
title: "Three.js 风力涡轮机尾迹教程"
description: "详解 Three.js 风力涡轮机尾迹：用 Canvas 2D 绘制内容并实时映射为 Three.js 纹理，涵盖 OrbitControls、THREE.Points、Canvas 等关键实现，附完整源码与在线 Demo，适合 Three.js 应用场景 学习与二次开发。"
head:
  - - meta
    - name: keywords
      content: "Three.js,风力涡轮机尾迹,WebGL,源码,教程,在线案例,OrbitControls,相机控制,粒子特效,Points,Canvas纹理,动态贴图"
outline: deep
---

### 风力涡轮机尾迹 · *Wind Turbine Wake* · [▶ 在线运行案例](https://z2586300277.github.io/three-cesium-examples/#/codeMirror?navigation=ThreeJS&classify=application&id=windTurbineWake)
...
本案例演示 **风力涡轮机尾迹** 效果：用 Canvas 2D 绘制内容并实时映射为 Three.js 纹理；核心用到 OrbitControls、THREE.Points、Canvas。建议先打开文首在线案例查看动态画面，再对照下方源码逐步理解。
...
- 本文提供 **风力涡轮机尾迹** 完整 Three.js 源码与在线 Demo，建议先运行案例再改 uniform/参数做二次实验
