---
title: "Cesium 高德纠偏教程"
description: "详解 Cesium.js 高德纠偏：BD-09(百度坐标系) To GCJ-02(火星坐标系)，涵盖 Cesium 等关键实现，附完整源码与在线 Demo，适合 Cesium 离线地图 学习与二次开发。"
head:
  - - meta
    - name: keywords
      content: "Cesium.js,高德纠偏,WebGL,源码,教程,在线案例,Cesium,Cesium Entity,实体"
outline: deep
---

### 高德纠偏 · *Gaode Transform* · [▶ 在线运行案例](https://z2586300277.github.io/three-cesium-examples/#/codeMirror?navigation=CesiumJS&classify=offline&id=gaodeTrans)
...
本案例演示 **高德纠偏** 效果：BD-09(百度坐标系) To GCJ-02(火星坐标系)；核心用到 Cesium。建议先打开文首在线案例查看动态画面，再对照下方源码逐步理解。
...
完整源码：[GitHub](https://github.com/z2586300277/three-cesium-examples/blob/dev/cesiumExamples/layer/gaodeTrans.js)

## 小结
- 本文提供 **高德纠偏** 完整 Cesium.js 源码与在线 Demo，建议先运行案例再改 uniform/参数做二次实验
