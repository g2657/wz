---
title: "Cesium 3D热力图教程"
description: "详解 Cesium.js 3D热力图：创建三维热力图，涵盖 Canvas 等关键实现，附完整源码与在线 Demo，适合 Cesium 扩展 学习与二次开发。"
head:
  - - meta
    - name: keywords
      content: "Cesium.js,3D热力图,WebGL,源码,教程,在线案例,Cesium,Canvas纹理,动态贴图"
outline: deep
---
### 3D热力图 · *3D Heat Map* · [▶ 在线运行案例](https://z2586300277.github.io/three-cesium-examples/#/codeMirror?navigation=CesiumJS&classify=expand&id=3DheatMap)
...
完整源码：[GitHub](https://github.com/z2586300277/three-cesium-examples/blob/dev/cesiumExamples/expand/3DheatMap.js)
