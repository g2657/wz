---
title: "Cesium 热力图教程"
description: "详解 Cesium.js 热力图：设置数据的最大最小值，涵盖 Canvas、Cesium 等关键实现，附完整源码与在线 Demo，适合 Cesium 扩展 学习与二次开发。"
head:
  - - meta
    - name: keywords
      content: "Cesium.js,热力图,WebGL,源码,教程,在线案例,Cesium,Canvas纹理,动态贴图,Cesium Entity,实体"
outline: deep
---
### 热力图 · *Heat Map* · [▶ 在线运行案例](https://z2586300277.github.io/three-cesium-examples/#/codeMirror?navigation=CesiumJS&classify=expand&id=heatMap)
...
完整源码：[GitHub](https://github.com/z2586300277/three-cesium-examples/blob/dev/cesiumExamples/expand/heatMap.js)
