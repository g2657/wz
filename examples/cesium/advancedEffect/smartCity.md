---
title: "Cesium 智慧城市光教程"
description: "详解 Cesium.js 智慧城市光：加载倾斜摄影或人工 3D Tiles 白膜并自动定位相机，涵盖 Cesium3DTileset、3D 等关键实现，附完整源码与在线 Demo，适合 Cesium 高级特效 学习与二次开发。"
head:
  - - meta
    - name: keywords
      content: "Cesium.js,智慧城市光,WebGL,源码,教程,在线案例,Cesium,3D Tiles,倾斜摄影"
outline: deep
---

### 智慧城市光 · *City Light* · [▶ 在线运行案例](https://z2586300277.github.io/three-cesium-examples/#/codeMirror?navigation=CesiumJS&classify=advancedEffect&id=smartCity)
...
本案例演示 **智慧城市光** 效果：加载倾斜摄影或人工 3D Tiles 白膜并自动定位相机；核心用到 Cesium3DTileset、3D。建议先打开文首在线案例查看动态画面，再对照下方源码逐步理解。
...
完整源码：[GitHub](https://github.com/z2586300277/three-cesium-examples/blob/dev/cesiumExamples/basic/smartCity.js)

## 小结
- 本文提供 **智慧城市光** 完整 Cesium.js 源码与在线 Demo，建议先运行案例再改 uniform/参数做二次实验
