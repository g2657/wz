---
title: "Cesium 绘制图形并导出geojson教程"
description: "详解 Cesium.js 绘制图形并导出geojson：Cesium绘图并导出GeoJSON工具，涵盖 Cesium、GeoJSON 等关键实现，附完整源码与在线 Demo，适合 Cesium 工具 学习与二次开发。"
head:
  - - meta
    - name: keywords
      content: "Cesium.js,绘制图形并导出geojson,WebGL,源码,教程,在线案例,Cesium,Cesium Entity,实体,GeoJSON,矢量数据"
outline: deep
---

### 绘制图形并导出geojson · *Draw and export geojson* · [▶ 在线运行案例](https://z2586300277.github.io/three-cesium-examples/#/codeMirror?navigation=CesiumJS&classify=tools&id=Draw+and+export+geojson)
...
本案例演示 **绘制图形并导出geojson** 效果：Cesium绘图并导出GeoJSON工具，本工具提供交互式点、线、面绘制功能，并能导出为标准GeoJSON格式；核心用到 Cesium、GeoJSON。建议先打开文首在线案例查看动态画面，再对照下方源码逐步理解。
...
完整源码：[GitHub](https://github.com/z2586300277/three-cesium-examples/blob/dev/cesiumExamples/tools/DrawAndExportGeojson.js)

## 小结
- 本文提供 **绘制图形并导出geojson** 完整 Cesium.js 源码与在线 Demo，建议先运行案例再改 uniform/参数做二次实验
