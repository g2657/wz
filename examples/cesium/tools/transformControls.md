---
title: "Cesium 3D 变换控制器教程"
description: "详解 Cesium.js 3D 变换控制器：Cesium Transform Controls - 模型变换控制器演示，涵盖 3D 等关键实现，附完整源码与在线 Demo，适合 Cesium 工具 学习与二次开发。"
head:
  - - meta
    - name: keywords
      content: "Cesium.js,Cesium 3D 变换控制器,WebGL,源码,教程,在线案例,Cesium,3D Tiles"
outline: deep
---

### Cesium 3D 变换控制器 · *Cesium 3D Transform Controls* · [▶ 在线运行案例](https://z2586300277.github.io/three-cesium-examples/#/codeMirror?navigation=CesiumJS&classify=tools&id=transformControls)
...
本案例演示 **Cesium 3D 变换控制器** 效果：基于 WebGL 实现「Cesium 3D 变换控制器」可视化效果，附完整可运行源码；核心用到 3D。建议先打开文首在线案例查看动态画面，再对照下方源码逐步理解。
...
- 本文提供 **Cesium 3D 变换控制器** 完整 Cesium.js 源码与在线 Demo，建议先运行案例再改 uniform/参数做二次实验
