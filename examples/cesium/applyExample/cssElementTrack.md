---
title: "Cesium div随轨迹运动教程"
description: "详解 Cesium.js div随轨迹运动：Cesium飞行轨迹跟踪弹窗示例，涵盖 Cesium 等关键实现，附完整源码与在线 Demo，适合 Cesium 应用 学习与二次开发。"
head:
  - - meta
    - name: keywords
      content: "Cesium.js,div随轨迹运动,WebGL,源码,教程,在线案例,Cesium,Cesium Entity,实体"
outline: deep
---

### div随轨迹运动 · *cssElementTrack* · [▶ 在线运行案例](https://z2586300277.github.io/three-cesium-examples/#/codeMirror?navigation=CesiumJS&classify=applyExample&id=cssElementTrack)
...
本案例演示 **div随轨迹运动** 效果：Cesium飞行轨迹跟踪弹窗示例，在飞行器沿轨迹移动时，显示一个跟随的弹窗显示当前位置信息；核心用到 Cesium。建议先打开文首在线案例查看动态画面，再对照下方源码逐步理解。
...
完整源码：[GitHub](https://github.com/z2586300277/three-cesium-examples/blob/dev/cesiumExamples/application/cssElementTrack.js)

## 小结
- 本文提供 **div随轨迹运动** 完整 Cesium.js 源码与在线 Demo，建议先运行案例再改 uniform/参数做二次实验
