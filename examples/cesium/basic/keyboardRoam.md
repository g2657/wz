---
title: "Cesium 键盘漫游教程"
description: "详解 Cesium.js 键盘漫游：初始化Cesium Viewer，涵盖 Viewer、Scene、Camera 等关键实现，附完整源码与在线 Demo，适合 Cesium 基础 学习与二次开发。"
head:
  - - meta
    - name: keywords
      content: "Cesium.js,键盘漫游,WebGL,源码,教程,在线案例,Cesium"
outline: deep
---

### 键盘漫游 · *Keyboard Roam* · [▶ 在线运行案例](https://z2586300277.github.io/three-cesium-examples/#/codeMirror?navigation=CesiumJS&classify=basic&id=keyboardRoam)
...
完整源码：[GitHub](https://github.com/z2586300277/three-cesium-examples/blob/dev/cesiumExamples/basic/keyboardRoam.js)
