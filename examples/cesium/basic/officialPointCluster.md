---
title: "Cesium 官方点聚合教程"
description: "详解 Cesium.js 官方点聚合：工具函数：生成聚合图标，涵盖 Canvas 等关键实现，附完整源码与在线 Demo，适合 Cesium 基础 学习与二次开发。"
head:
  - - meta
    - name: keywords
      content: "Cesium.js,官方点聚合,WebGL,源码,教程,在线案例,Cesium,Canvas纹理,动态贴图"
outline: deep
---

### 官方点聚合 · *Official Point Cluster* · [▶ 在线运行案例](https://z2586300277.github.io/three-cesium-examples/#/codeMirror?navigation=CesiumJS&classify=basic&id=officialPointCluster)
...
完整源码：[GitHub](https://github.com/z2586300277/three-cesium-examples/blob/dev/cesiumExamples/basic/officialPointCluster.js)

## 小结

- 本文提供 **官方点聚合** 完整 Cesium.js 源码与在线 Demo，建议先运行案例再改 uniform/参数做二次实验
